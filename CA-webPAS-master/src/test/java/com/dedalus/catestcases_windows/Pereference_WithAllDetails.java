...
public class Pereference_WithAllDetails extends RESTAssuredBase {
  ...
  public void setData(String SOR) throws IOException, InterruptedException, AWTException {
    testCaseName = "Patient preference with all details validations ";
  ...
  @Parameters({"SOR"})
  @Test
  public void patPrefWithData(String SOR, ITestContext context) throws InterruptedException, IOException, ClassNotFoundException, SQLException, ParseException, AWTException {
