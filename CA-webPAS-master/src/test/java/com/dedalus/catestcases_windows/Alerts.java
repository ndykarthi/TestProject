...
public class Alerts extends RESTAssuredBase {

	@Parameters({"SOR"})
	
  @BeforeTest
  public void setData(String SOR) throws IOException, InterruptedException, AWTException {
    testCaseName = "Patient Alerts validations";
    testDescription = "This test is to verify the Alerts with IP and Contact Encounter for Active,Inactive - Closed and Strikeout";
    nodes = SOR;
    category = "Regression";
    authors = "Kavitha";
  }
  ...
  public void alerts(String SOR, ITestContext context) throws InterruptedException, IOException, ClassNotFoundException, SQLException, ParseException, AWTException {
		...
		AssertStringContains(SummaryAlertType, SORActiveAlertSeverityLevel, "Summary Alert Sev Level");
		...
		String summaryAlertIcon = getIconName(summPg.AlertIcon, "Summary Alert Icon");
	  ...
	  int allActiveCount = alertPg.getAlertActiveCount();
		...
		AssertStringEquals(ActiveTabCnt1, "2", "Count of alerts in All tab");
...
//	  AssertStringEquals(SORCloseAlertRecordedBy, ClosedAlertRecordedBy, "Closed Alert Recorded By");
	  ...
	  AssertStringEquals(SORInitiatingHospital, ClosedAlertIniHosp, "Closed Alert Initiating Hospital");
	  AssertStringContains(ClosedAlertRevDate, SORCloseAlertRevDate, "Closed Alert Review Date");
