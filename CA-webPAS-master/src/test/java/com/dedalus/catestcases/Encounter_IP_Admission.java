...
public class Encounter_IP_Admission extends RESTAssuredBase{
	...
	public void setData(String PlatformName, String DeviceName, String PlatformVersion) throws IOException, InterruptedException, AWTException {
		...
		nodes = "The following test case verify Encounter - Inpatient Admission and My worklist overview" ;
		category = "Regression";
		authors = "Karthi";
	}
...
//		========================================= VIRTUOSO API =========================================
        ...
        AssertStringContains(IPEncCareProvider, SORCPTitle+" "+SORCareProvider, "Inpatient encounter Care provider");
        
        //String IPEncSpecialty = getText(enc.ipEncSpecialty, "Inpatient encounter Specialty");		
        ...
        String MyWL_IP_Bed = getText(worklistPg.MyWorkListEncBed, "My worklist OP Enc Bed");
        MyWL_IP_Bed = MyWL_IP_Bed.substring(3);
        AssertStringEquals(MyWL_IP_Bed, SORIPBed, "MyWL_IP_Ward");
