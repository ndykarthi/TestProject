...
public class Encounter_IP_PreAdmission extends RESTAssuredBase{
	...
	public void setData(String PlatformName, String DeviceName, String PlatformVersion) throws IOException, InterruptedException, AWTException {
		testCaseName = "Encounter - Inpatient Pre-Admission ["+PlatformName+" "+DeviceName+" (Version : "+PlatformVersion+")]"; 
		testDescription = "The following test case verify Encounter - Pre-Admission";
		nodes = "The following test case verify Encounter - Pre-Admission" ;
		category = "Regression";
		authors = "Karthi";
	}
	...
	@Test
	public void PreAdmission(String SOR, String PlatformName,String DeviceName,String PlatformVersion,String DeviceOrientation, ITestContext context, String DeviceType)
...
//		========================================= VIRTUOSO API =========================================
		...
		jsclick(worklistPg.MyWorkListPlannedTab, "My worklist overview IP Planned tab");
		Thread.sleep(3000);
		VerifyElementNotPresent(driver.findElementsByXPath("//DXC-LIST-ITEMS//ION-ITEM-GROUP//ION-ITEM-SLIDING//*[contains(text(),'"+SORHRN+"')]"));
		...
		SearchNMarkFavourite("Care Provider",SORCareProvider);
		Thread.sleep(5000);	
		click(mnuPg.clickMenuNew, "Menu");
		Thread.sleep(5000);
