...
public class Theatres_IPEnc_PlannedTab extends RESTAssuredBase{
	...
	public void setData(String PlatformName, String DeviceName, String PlatformVersion) throws IOException, InterruptedException, AWTException {
		testCaseName = "Theatres - Planned Tab ["+PlatformName+" "+DeviceName+" (Version : "+PlatformVersion+")]"; 
		testDescription = "The following test case verify Theatres - Planned Tab";
		nodes = "The following test case verify Theatres - Planned Tab" ;
		category = "Regression";
		authors = "Karthi";
	}
...
//		========================================= VIRTUOSO API =========================================
		...
		Thread.sleep(10000);
		jsclick(mnuPg.GeneralMenu,"expand General");
		Thread.sleep(15000);
		javascriptScroll(driver.findElementByXPath("//ion-label[text()='Planned admission days']"), "Planned admission days");
