...
public class Theatres_NoEnc extends RESTAssuredBase{
	...
	public void setData(String PlatformName, String DeviceName, String PlatformVersion) throws IOException, InterruptedException, AWTException {
		testCaseName = "Theatres - NoEnc["+PlatformName+" "+DeviceName+" (Version : "+PlatformVersion+")]"; 
		testDescription = "The following test case verify Theatres (No Enc)";
		nodes = "The following test case verify Theatres (No Enc)" ;
		category = "Regression";
		authors = "Karthi";
	}
