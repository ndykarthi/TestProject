...
public class Encounters extends RESTAssuredBase {
	...
	public void setData(String PlatformName, String DeviceName, String PlatformVersion) throws IOException, InterruptedException, AWTException {
		testCaseName = "Encounters ["+PlatformName+" "+DeviceName+" (Version : "+PlatformVersion+")]"; 
		testDescription = "The following test case verify Encounters and My worklist overview";
		nodes = "The following test case verify Encounters and My worklist overview" ;
		category = "Regression";
		authors = "Karthi";
	}
	...
	public void ViewEncountersTest(String SOR, String PlatformName,String DeviceName,String PlatformVersion,String DeviceOrientation, ITestContext context, String DeviceType)
		...
		if(SOR.equals("WEBPAS"))
		{
			...
			{
				jsclick(enc.backToPatientsearchIcon, "Navigate back to patient search icon");
				Thread.sleep(6000);
			}
			...
			String encListIPEncPlannedDate = getText(enc.encListIPEncStartDate, "EncounterList Inpatient encounter Start date");
...
//			AssertStringContains(MyWL_ED_Patdet_CPName, "No participant", "MyWL_ED_Patdet_CPName");
		...
		else if(SOR.equals("LORENZO"))
		{
			...
			String MyWL_OP_Building = getText(worklistPg.MyWorkListEncBuilding, "My worklist OP Enc Building");
			String MyWL_OP_Bay = getText(worklistPg.MyWorkListEncBay, "My worklist OP Enc Bay");

			jsclick(worklistPg.MyWorkListMorePatDetailsIcon, "My worklist overview More patient details");
			Thread.sleep(3000);
			String MyWL_OP_Patdet_PatGender = getText(worklistPg.MyWorkListMorePatGender, "My worklist OP Enc More details Pat Gender");
			String MyWL_OP_Patdet_EncLocation = getText(worklistPg.MyWorkListMoreEncLocation, "My worklist OP Enc More details  Location");
			...
			String MyWL_OP_Patdet_StartDate = getText(worklistPg.MyWorkListMoreEncPlannedDate, "My worklist Contacts Enc More details  startdate");
			...
			jsclick(worklistPg.MyWorkListMarkUnfavouriteIcon, "My worklist overview unfavourite");
			Thread.sleep(3000);
			jsclick(worklistPg.MyWorkListAdmittedTab, "My worklist overview admitted tab");
			Thread.sleep(3000);
			jsclick(worklistPg.MyWorkListOutpatientTab, "My worklist overview Outpatient tab");
			click(mnuPg.clickMenu, "Menu");
			click(mnuPg.menu_Search,"Search");
			...
			String MyWL_ED_Building = getText(worklistPg.MyWorkListEncBuilding, "My worklist OP Enc Building");
			String MyWL_ED_Bay = getText(worklistPg.MyWorkListEncBay, "My worklist OP Enc Bay");
			...
			AssertStringEquals(MyWL_OP_Patdet_EncLocation, (MyWL_OP_Bay +", "+MyWL_OP_Building), "MyWL_OP_Patdet_EncLocation");
			...
			AssertStringEquals(MyWL_OP_Patdet_StartDate, SOROPStartDate, "MyWL_OP_Patdet_StartDate");
