...
public class Allergies_Active extends  RESTAssuredBase{
	...
	public void setData(String PlatformName,String DeviceName,String PlatformVersion,String DeviceOrientation) throws IOException, InterruptedException, AWTException {
		...
		testDescription = "The following test case verify Active allergies";
...
//		========================================= VIRTUOSO API =========================================
		...
		jsclick(allergy.WPexpandActiveAllergy1, "Expanding Active allergy 1");
		Thread.sleep(3000);

		String ActiveAllergy1ReviewDate = getText(allergy.getMildActiveAllergyReviewDate, "ActiveAllergy1ReviewDate");
		AssertStringEquals(ActiveAllergy1ReviewDate, SORCurrentDate, "ActiveAllergy1ReviewDate");
