...
public class Results_Textual extends RESTAssuredBase{
	...
	public void setData(String PlatformName, String DeviceName, String PlatformVersion) throws IOException, InterruptedException, AWTException {
		testCaseName = "Textual results - NoEnc["+PlatformName+" "+DeviceName+" (Version : "+PlatformVersion+")]"; 
		testDescription = "The following test case verify Textual results";
		nodes = "The following test case verify Textual results" ;
		category = "Regression";
		authors = "Karthi";
	}
	...
	@Test
	public void createTest(String SOR, String PlatformName,String DeviceName,String PlatformVersion,String DeviceOrientation, ITestContext context, String DeviceType)
