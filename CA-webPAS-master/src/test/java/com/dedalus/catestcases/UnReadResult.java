...
public class UnReadResult extends RESTAssuredBase{
	...
	public void setData(String PlatformName,String DeviceName,String PlatformVersion,String DeviceOrientation) throws IOException, InterruptedException, AWTException {
		testCaseName = "UnRead Results "+PlatformName+" - "+DeviceName+" - "+PlatformVersion+" - "+DeviceOrientation;
		testDescription = "This test is to verify the Results(UnRead) of a patient";
	...
	public void result(String SOR,String PlatformName,String DeviceName,String PlatformVersion,String DeviceOrientation, ITestContext context) throws InterruptedException, FileNotFoundException, IOException, AWTException, ClassNotFoundException, SQLException, ParseException
	{
		...
		VerifyHaematologyTextTabView("Hct",SORLab,SORDiagGp,SORSamplePerfDate);
		VerifyHaematologyTextTabView("Others Specify",SORLab,SORDiagGp,SORSamplePerfDate);
		VerifyHaematologyTextTabView("Film",SORLab,SORDiagGp,SORSamplePerfDate);
		VerifyHaematologyTextTabView("Processed By",SORLab,SORDiagGp,SORSamplePerfDate);
		VerifyHaematologyTextTabView("Checked By",SORLab,SORDiagGp,SORSamplePerfDate);
